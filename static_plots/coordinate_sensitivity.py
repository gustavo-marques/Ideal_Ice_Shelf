...
path='/lustre/f1/unswept/Gustavo.Marques/MOM6-examples/ice_ocean_SIS2/IDEAL_IS/dx2km/'
icfile = 'IDEAL_IS_IC.nc'
exps = ['Layer/M2_exp2','Sigma_zstar/M2_exp2']
fnames = ['M2_exp2_2km_layer','M2_exp2_2km']
param = 'coordinate'
labels = ['Isopycnal','Sigma/Z*']
...
for n in range(len(vars)):
   ...
   for i in range(len(exps)):
       ...
       std_all[i]=data.std()
       plt.errorbar(i, mean_all[i], yerr=std_all[i], fmt='o',label=labels[i])
