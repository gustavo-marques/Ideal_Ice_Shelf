...
path='/work/gmm/Projects/Ideal_ice_shelf/Mode2/dx1km/M2_exp0/out1/'
...
e   = netCDF4.Dataset(path+'prog.nc').variables['e'][-1,:,:,250]
h   = netCDF4.Dataset(path+'prog.nc').variables['h'][-1,:,:,250]
ssh = netCDF4.Dataset(path+'IDEAL_IS_IC.nc').variables['ave_ssh'][0,:,0]
...
ax1.plot([220,220],[-920,-5],'k',linewidth=1)
ax1.plot([5,5],[-920,-5],'k',linewidth=1)
# zoom
...
ax1.fill_between(yh, e[0,:], 0.0, facecolor='white', interpolate=True)
ax1.fill_between(yh, e[-1,:], -4000, facecolor='lightgray', interpolate=True)
ax1.plot(yh, ssh,'k-',lw=1.5)

ax2.fill_between(yh, e[0,:], 0.0, facecolor='white', interpolate=True)
ax2.fill_between(yh, e[-1,:], -4000, facecolor='lightgray', interpolate=True)
ax2.plot(yh, ssh,'k-',lw=1.5)

# lines
ax1.plot([5,50],[-920,-3412],'k',linewidth=1)
ax1.plot([220,500],[-5,-1380],'k',linewidth=1)
