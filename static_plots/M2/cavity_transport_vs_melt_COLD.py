...
exps1 = ['M2_exp0','M2_exp1','M2_exp2'] # melt on
exps2 = ['M2_exp13','M2_exp15','M2_exp16'] # melt off

dx = ['dx1','dx2','dx5','dx10']
dx1 = ['1km','2km','5km','10km']

param = 'cavity_transport_vs_melt_COLD2'
...
for j in range(len(dx)):
  ...
  # TEXT
  ax1.text(25,tx[j],r'$\eta_{dyn}$ = '+str(m), color=colors[j], fontsize=20)
