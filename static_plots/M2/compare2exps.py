...
fnames1 = ['M2_exp4','M2_exp19','M2_exp20']
...
for n in range(len(vars)):
 ...
 #  plt.errorbar(xval, mean_all, yerr=std_all, fmt='o')
  # plt.plot(xval, mean_all,'k-')
   ...
   ax.set_xlabel(r'Exps.', fontsize=20)
   plt.grid()
   plt.savefig(param+'_'+vars[n]+'.png',format='png',dpi=300,bbox_inches='tight')
   #plt.close()
   plt.show()
