...
def driver(args):
   ...
   fig, axes = plt.subplots(nrows=2, ncols=2,sharex='col', sharey='row',figsize=(12,8))
   ...
   for ax in axes.flat:
     ...
     ax.fill_between(x[0,:],y_fill,0, facecolor='gray', interpolate=True)
   ...
   cbar_ax = fig.add_axes([0.16, 0.11, 0.7, 0.03])
   ...
   plt.savefig('PSI/barotropic_melt_dx1.png',format='png',dpi=300,bbox_inches='tight')
   plt.show()
   print 'Done!'
